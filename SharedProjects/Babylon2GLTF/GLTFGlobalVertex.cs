...
namespace GLTFExport.Entities
{
    public class GLTFGlobalVertex
    {
        ...
        public ushort[] BonesIndicesExtra1 { get; set; }
        public ushort[] BonesIndicesExtra2 { get; set; }
        public ushort[] BonesIndicesExtra3 { get; set; }
        public float[] BonesWeights { get; set; }
        public float[] BonesWeightsExtra1 { get; set; }
        public float[] BonesWeightsExtra2 { get; set; }
        public float[] BonesWeightsExtra3 { get; set; }
    }
}
